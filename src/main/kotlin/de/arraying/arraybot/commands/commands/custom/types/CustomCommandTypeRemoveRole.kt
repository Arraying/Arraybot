 ...
 */
class CustomCommandTypeRemoveRole:
        CustomCommandType(CustomCommandTypes.REMOVEROLE) {

    /**
     * Gets the message.
     */
    override fun getMessage(channel: TextChannel): String {
        return Messages.CUSTOMCOMMAND_REMOVEROLE.content(channel)
    }
    ...
    override fun invoke(environment: CommandEnvironment, value: String) {
        CustomCommandRoleAction.execute(environment, value, CustomCommandTypes.REMOVEROLE)
    }
