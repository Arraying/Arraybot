...
enum class Messages {
    ...
    COMMAND_MUTESETTINGS_EMBED_DESCRIPTION,
    COMMAND_MUTESETTINGS_EMBED_TITLE,
    COMMAND_MUTESETTINGS_EMBED_VALUE,
    COMMAND_MUTESETTINGS_SETPERM_PROVIDE,
    COMMAND_MUTESETTINGS_SETPERM_INVALID,
    COMMAND_MUTESETTINGS_SETPERM_UPDATE,
    COMMAND_MUTESETTINGS_SETROLE_PROVIDE,
    COMMAND_MUTESETTINGS_SETROLE_INVALID,
    COMMAND_MUTESETTINGS_SETROLE_UPDATE,
    ...
    PUNISH_COMMAND_MUTE_PERMISSION,
    PUNISH_COMMAND_MUTE_ROLE;
