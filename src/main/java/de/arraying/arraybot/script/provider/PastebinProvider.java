 ...
 */
public final class PastebinProvider implements PrimeSourceProvider {

    /**
     * The Pastebin pattern.
     */
    private static final Pattern PATTERN = Pattern.compile("http(s)?://pastebin\\.com/raw/[0-9a-zA-Z]+");
