package de.arraying.arraybot.core.listener.listeners.postload;

import de.arraying.arraybot.Arraybot;
import de.arraying.arraybot.core.listener.Listener;
 ...
 */
public class DeathListener extends PostLoadListener {
    ...
    public void onGenericEvent(Event event) {
        ...
        shard.setLastEvent(System.currentTimeMillis());
    }
