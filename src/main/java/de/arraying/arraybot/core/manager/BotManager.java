package de.arraying.arraybot.core.manager;

import de.arraying.arraybot.Arraybot;
import de.arraying.arraybot.core.data.Configuration;
import de.arraying.arraybot.core.listener.listeners.PostLoadListener;
import de.arraying.arraybot.core.listener.listeners.postload.DeathListener;
import de.arraying.arraybot.core.listener.listeners.preload.ReadyListener;
...
public class BotManager {
    ...
    public synchronized void ready(int shard) {
        ...
        entry.setLastEvent(System.currentTimeMillis());
